...
MAKEFILE = [
    ...
    api.browserify_file('www-dev/js/website.js', 'www/js/website.js', babelify=False, export_as=None),

    # Browserify ES6 code with optional React JSX
    api.browserify_file('www-dev/jsx/index.js', 'www/js/reactjsx.js', babelify=True, export_as='reactjsx'),
